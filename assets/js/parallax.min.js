...
! function(t, i, e, s) {
    function o(i, e) {
        ...
        // if all of these return true then return the current the instance of the object
        if (r.length < 1 && r.push("center"), 
        // this looks scary but it's just an "extended" if statement that evaluates a bunch of stuff  
        ...
        // if you're using android then do something
